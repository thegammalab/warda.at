...
<div class="vouchers_page">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3 col-xl-2 the_sidebar pt-5">
         <div class="left_sidebar">
          <form action="" class="filters">
            ...
            <div class="vouchers_filters">
              <h5 class="">filter</h5>
              <?php
              $category_slug = "voucher_cat";
      ...
      <div class="col-md-9 col-xl-10 white_bg pr-xl-4">
          ...
          <div class="search_bar d-none d-md-block">
            <div class="form-group align-middle mb-0">
              <div class="input-group ">
                ...
                <div class="input-group-append">
                  <button type="button" class="input-group-text btn-primary voucher_indigo" id="search_but_right"><span class="d-none d-lg-block">Suchen</span>
        ...
        <div class="row mb-8" id="results_div">
            <?php
            $feat_events = apply_filters('tdf_get_posts', "vouchers", 99, 0, array("search" => array("exclude"=>$exclude_ids)));
