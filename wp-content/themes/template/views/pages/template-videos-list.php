        ...
        <div class="left_sidebar">
          ...
          <div class="d-block d-md-none">
            <div class="filters_list">
              ...
              <div><select class="form-control"><option>Type</option></select></div>
            </div>
          </div>
          <div class="d-none d-md-block">
            ...
            <div class="filter_box">
              ...
              <ul class="filter1">
                ...
                <li class="light_blue_text"><i class="fas fa-chevron-down"></i>Weitere Termine</li>
              </ul>
            </div>
            <div class="filter_box">
              <div class="filter_title">
      ...
      <div class="col-md-8 col-xl-6 grey_bg">
        <div class="mb-5">
          ...
          <ul class="filter_list">
            <li><a href="#">Heute </a><a href="#"><img src="<?php echo get_bloginfo("template_directory"); ?>/assets/images/close-icon-fuchsia.svg" alt=""></a></li>
            <li><a href="#">Rock</a><img src="<?php echo get_bloginfo("template_directory"); ?>/assets/images/close-icon-fuchsia.svg" alt=""></a></li>
          ...
          <div class="col-md-6">
            <div class="mb-5">
              <div class="video_box position-relative">
                <a href="<?=get_bloginfo("url"); ?>/videos/details/"><img src="<?php echo get_bloginfo("template_directory"); ?>/assets/images/video1.jpg" class="w-100" alt=""></a>
                <a href="<?=get_bloginfo("url"); ?>/videos/details/" class="play_btn position-absolute d-flex m-auto">
                  <img src="<?php echo get_bloginfo("template_directory"); ?>/assets/images/playbtn.png" alt="">
                </a>
              </div>
              <div class="photo_date_place text-center">
                <p class="m-auto">Mo, 24. Februar 2020</p>
                <div class="m-auto">
                  <a href="<?=get_bloginfo("url"); ?>/videos/details/">
