...
<section class="woocommerce-customer-details ">
	...
	<h4 class="woocommerce-column__title text-left mb-4"><?php esc_html_e( 'Billing address', 'woocommerce' ); ?></h4>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-6">
			<h4 class="woocommerce-column__title text-left mb-4"><?php esc_html_e( 'Shipping address', 'woocommerce' ); ?></h4>
			<address>
