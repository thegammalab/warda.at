                    ...
                    <tfoot>
                        <tr>
                            <th colspan="2">
	                            ...
	                            <!-- Offload to S3 Button	-->
	                            <a href="#" class="ssu-offload-file-row dokan-btn dokan-btn-sm dokan-btn-success"
	                               style="margin-left: 8px;" data-row="<?php
	                            $file = array(
		                            'file' => '',
		                            'name' => '',
	                            );
	                            ...
	                            include DOKAN_INC_DIR . '/woo-views/html-product-download.php';
	                            echo esc_attr( ob_get_clean() );
	                            ?>"><?php esc_html_e( 'Offload to S3', 'dokan-lite' ); ?></a>
	                            <span class="ssu-add-media-btn">
		                            <input type="checkbox" class="ssu-offload-add-media"/><?php esc_html_e( 'Add to Media Library', 'dokan-lite' ); ?>
	                            </span>
	                            <!-- End Offload to S3 Button -->
                            </th>
                        </tr>
                    </tfoot>
                    <thead>
