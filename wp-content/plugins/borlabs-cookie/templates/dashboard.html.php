<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php _ex('Dashboard', 'Backend / Dashboard / Breadcrumb', 'borlabs-cookie'); ?></li>
    </ol>
</nav>
...
<div class="row">
    <div class="col">
        <div class="px-3 pt-3 pb-3 mb-4 bg-dark text-light shadow-sm rounded">
            <h3 class="border-bottom mb-3"><?php printf(_x('Statistics <small class="text-muted">- Cookie Version %s</small>', 'Backend / Dashboard / Headline', 'borlabs-cookie'), $cookieVersion); ?></h3>
            <div class="row">
                <div class="col">
                    <?php
                    if (!empty($chartData)) {
                    ?>
                        <div style="height: 200px;"><canvas id="borlabsCookieChart"></canvas></div>
                    ...
                    ?><div class="alert alert-warning" role="alert"><?php _ex('No data available yet. Please try again in a few hours.', 'Backend / Dashboard / Alert Message', 'borlabs-cookie'); ?></div><?php
                    }
                    ?>
                </div>
            </div>
    ...
    <div class="col-12 col-md-7">
        ...
        <div class="mb-4 px-3 pt-3 pb-4 rounded bg-light shadow-sm">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    ?>
                    <div class="mb-4">
                        <h4 class="d-flex justify-content-between"><?php echo esc_html($newsData->title); ?> <small class="text-muted"><?php echo \BorlabsCookie\Cookie\Tools::getInstance()->formatTimestamp($newsData->timestamp, null, false); ?></small></h4>
                        <?php
        ...
        <div class="mb-4 px-3 pt-3 pb-4 rounded bg-light shadow-sm">
            ...
            <div class="row">
                <div class="col-12">
                    <ol class="help-list">
                        <li><span><?php _ex('Under <strong>Cookies</strong> enter your Cookies/JavaScripts, e.g. Google Analytics or Facebook Pixel. Make sure that you insert the JavaScripts such as Google Analytics <strong>only</strong> in the Borlabs Cookie.', 'Backend / Dashboard / Text', 'borlabs-cookie'); ?></span></li>
                        <li><span><?php _ex('Configure Borlabs Cookie under <strong>Settings</strong> and activate the system by turning <strong>Borlabs Cookie Status</strong> on.', 'Backend / Dashboard / Text', 'borlabs-cookie'); ?></span></li>
                        <li><span><?php _ex('You can customize its appearance under <strong>Cookie Box</strong>.', 'Backend / Dashboard / Text', 'borlabs-cookie'); ?></span></li>
                        <li><span><?php _ex('If you are using a caching plugin, flush its cache.', 'Backend / Dashboard / Text', 'borlabs-cookie'); ?></span></li>
                        <li><span><?php _ex('Open your website in incognito/privacy mode for testing.', 'Backend / Dashboard / Text', 'borlabs-cookie'); ?></span></li>
                    </ol>
        ...
        <div class="mb-4 px-3 pt-3 pb-4 rounded bg-light shadow-sm">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="<?php _ex('https://borlabs.io/kb/introduction-borlabs-cookie-2-0/?utm_source=Borlabs+Cookie&amp;utm_medium=Dashboard+Video&amp;utm_campaign=Analysis', 'Backend / Dashboard / URL', 'borlabs-cookie'); ?>" target="_blank" rel="nofollow noopener noreferrer"><img src="<?php echo $this->imagePath; ?>/<?php _ex('video-en.jpg', 'Backend / Dashboard / Image', 'borlabs-cookie'); ?>" class="img-fluid" alt=""></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-sm d-inline-block w-75" id="borlabsCookieUID" name="borlabsCookieUID" data-borlabs-cookie-language="<?php echo esc_attr($language); ?>" value="" placeholder="UID: A1B2C3D4-E5F6G7H8-I9J1K2L3-M4N5O6P7">
                        <div class="input-group-append">
                            <button data-get-consent-history type="button" class="btn btn-primary btn-sm"><?php _ex('Send', 'Backend / Global / Button Title', 'borlabs-cookie'); ?></button>
                        </div>
                    </div>
                    ...
                    <div data-borlabs-cookie-consent-history>
                        <div data-borlabs-cookie-loading class="borlabs-hide">
                            <div class="d-flex justify-content-center">
                                <img src="<?php echo $loadingIcon; ?>" alt="" class="fa-spin" style="width: 32px; height: 32px;">
                            </div>
                        </div>
                        ...
                        <div data-borlabs-cookie-no-result class="borlabs-hide">
                            <div class="alert alert-warning" role="alert"><?php _ex('No data for UID found. Make sure the UID exists.', 'Backend / Dashboard / Alert Message', 'borlabs-cookie'); ?></div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            if (!empty($latestUIDData)) {
                                ...
                                <tr>
                                    ...
                                    <td class="borlabs-cursor" data-clipboard-universal="borlabsCookieUID"><?php echo esc_html(strtoupper($logData->uid)); ?></td>
                                </tr>
                                <?php
                                }
                            } else {
                                ?>
                                <tr>
                                    <td colspan="3" class="text-center"><?php _ex('No UIDs found.', 'Backend / Dashboard / Alert Message', 'borlabs-cookie'); ?></td>
                                </tr>
                                <?php
                            }
                            ?>
