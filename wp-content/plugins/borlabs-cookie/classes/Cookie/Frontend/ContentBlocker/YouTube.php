...
class YouTube
{
    ...
    public function getDefault()
    {
        $data = [
            ...
            'name' => 'YouTube',
            'description' => '',
            'privacyPolicyURL' => _x('https://policies.google.com/privacy?hl=en&amp;gl=en', 'Frontend / Content Blocker / YouTube / URL', 'borlabs-cookie'),
            'hosts' => [
                'youtube.com',
                'youtu.be',
    ...
    public function additionalSettingsHelpTemplate($data)
    {
        ...
        <div class="col-12 col-md-4 rounded-right shadow-sm bg-tips text-light">
            <div class="px-3 pt-3 pb-3 mb-4">
                ...
                <p><?php _ex('For themes that do not load the default Gutenberg CSS, this option must often be activated.', 'Backend / Content Blocker / YouTube / Tips / Text', 'borlabs-cookie'); ?></p>
            </div>
        </div>
        <?php
    }
