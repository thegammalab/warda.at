<?php
 ...
 class wpce_Review
 {
 	...
 	function __construct( $plugin_name, $transient_name, $installed_time, $review_url )
 	{
		...
		add_action( 'wp_ajax_wb_wpce_review_transient', array($this, 'set_review_transient') );
 	}
				...
				jQuery(document).ready(function(){
					jQuery('.wb-wpce-already-reviewed').on('click', function(e){
						...
						jQuery.ajax({
							...
							data: {
								action: 'wb_wpce_review_transient',
							},
...
$wpce_review = new wpce_Review(
				'Product Carousel Slider for Elementor',
				'wpce_elementor_review',
				'wpce_installed_time',
