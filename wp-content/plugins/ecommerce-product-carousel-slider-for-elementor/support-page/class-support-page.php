 ...
 *******************************/
add_action('wp_head', 'wpce_support_form_ajax_header');

if( !function_exists('wpce_support_form_ajax_header') )
{
	function wpce_support_form_ajax_header() 
	{
	...
	} //End of wpce_support_form_ajax_header
 ...
 *******************************/
add_action( 'wp_ajax_process_wpce_promo_form', 'process_wpce_promo_form' );

if( !function_exists('process_wpce_promo_form') )
{
	function process_wpce_promo_form()
	{
...
Please email to <span style="color:#22A0C9;font-weight:bold !important;font-size:14px "> webbuilders03@gmail.com </span> with any feedback. We will get back to you right away!', '');
		...
		else
		{
			...
			//$toEmail = "wbelnt.kadir@gmail.com"; //Receivers email address
 ...
 *******************************/
if( !class_exists('WPCE_SupportPage') ){


	class WPCE_SupportPage{
	
		public $plugin_menu_slug = "";
		public $plugin_slug = ""; //Should be unique, like: wbelntsld_p123
		...
		function __construct( $plugin_slug = null )
		{
			...
			//add_action( 'wp_ajax_process_wpce_promo_form', array(&$this,'process_wpce_promo_form') );
			
		} //End of Constructor
		
		function include_promo_page_scripts( $hook )
		{                                 
		   if( $hook == 'woo-elementor-product-carousel_page_wb-page-wpce-support' ){	   	
		...
		function show_promo_page_callback_func()
		{
			add_submenu_page(
				...
				'manage_options',
				$this->page_slug,
				array(&$this, 'wbelpspromo_support_page_callback_func' )
			);
		 ...
		 *******************************/
		function wbelpspromo_support_page_callback_func()
		{
			
			?>
				
				<div class="wpce-support-page-wrapper">
									...
									<div class="feature-plugin-right">
										...
										<div class="bottom-feature-plugin">
											...
											<div class="feature feature-plugin-02">
												...
												<h3>
													<a href="https://plugin-devs.com/product/news-ticker-for-elementor/" target="_blank">
			...
			<?php
		} //End of wbelpspromo_support_page_callback_function
		
		
	
	} //End of the class WPCE_SupportPage
...
//Supply Unique Promo Page Slug as the constructor parameter of the class WPCE_SupportPage. ex: sld-page-2124a to the constructor

//Please create an unique instance for your use, example: $instance_sldf2

$instance = new WPCE_SupportPage('wpce-support');

if( is_admin() )
{
	$instance->plugin_menu_slug = "wpce-slider"; //Edit Value
	$instance->plugin_name = "Woo Product Carousel Slider for Elementor"; //Edit Value
